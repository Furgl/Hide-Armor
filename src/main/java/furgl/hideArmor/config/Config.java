...
public class Config {
	...
	public static HashMap<HidingArmorSlot, Boolean> hideYourArmor = Maps.newHashMap();
	public static HashMap<HidingArmorSlot, Boolean> hideOtherPlayerArmor = Maps.newHashMap();
	...
	static {
		// defaults
		for (HidingArmorSlot slot : Utils.ARMOR_SLOTS) {
